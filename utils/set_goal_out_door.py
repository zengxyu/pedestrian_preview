...
from utils.store_worlds import display_and_save


def set_goal_outdoor():
    ...
    for filename in os.listdir(office_1000_random_envs_folder):
        ...
        out_image_path = os.path.join(out_office_1000_goal_outdoor_images_folder, filename[:filename.index(".")]+".png")
