...
class PFLearner:
    def __init__(self, env, agent, action_space, args):
        self.args = args
    ...
    def run(self):
        print("========================================Start running========================================")
        self.writer = SummaryWriter(log_dir=self.args.out_board)
        print("out_board=",self.args.out_board)
    ...
    def train_once(self):
        ...
        while not done:
            ...
            writerlist = self.agent.get_statistics()
            self.writer.add_scalar(writerlist[0][0], writerlist[0][1], writerlist[4][1])
            self.writer.add_scalar(writerlist[1][0], writerlist[0][1], writerlist[4][1])
            self.writer.add_scalar(writerlist[2][0], writerlist[0][1], writerlist[4][1])
            self.writer.add_scalar(writerlist[3][0], writerlist[0][1], writerlist[4][1])
            self.writer.add_scalar(writerlist[5][0], writerlist[0][1], writerlist[4][1])
            self.writer.add_scalar(writerlist[6][0], writerlist[0][1], writerlist[4][1])
