...
def test_compare_success_rate_of_different_algorithms_in_different_envs():
    ...
    x_label = "Re-plan every n"
    save_path = os.path.join(plot_folder, "success_rate_of_replan.png")

    title = "Compare different algorithm among replan every n"
...
def test_compare_path_length_of_different_algorithms_in_different_envs():
    ...
    save_path = os.path.join(plot_folder, "path_length_mean_of_different_replans.png")
...
def test_compare_closest_distance_of_different_algorithms_in_different_envs():
    ...
    x_names = conditions["env_types"]
    label_names = ["Re-plan every 3 inferences", "Re-plan every 3 inferences",
                   "Re-plan every 5 inferences", "No replan"]
    values = np.reshape(values, (len(x_names), len(label_names)))
    ...
    save_path = os.path.join(plot_folder, "min_distance_mean_of_replans.png")
